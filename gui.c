 ...
 */
int action_restrict;
int action_min, action_max, action_payment_which, action_payment_mil;
...
//bob
inline void label_set_text(char *buf) {
...
inline void widget_set_sensitive(bool activate) {
	gtk_widget_set_sensitive(action_button, activate);
}

inline void restore_table_area(int i) {
	player_area[i] = orig_area[i];
}

inline void restore_status_area(int i) {
